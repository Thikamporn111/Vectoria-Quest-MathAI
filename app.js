const quests = [
  ...
  {id:4,name:'แมงมุมฉากศิลา',title:'ผู้ถักใยมุม 90°',glyph:'⊥',quote:'ใยของข้าขวางทุกเส้นทางด้วยมุมฉาก เจ้าจะหาเส้นที่ลอดผ่านได้หรือไม่?',map:'วิหารเวกเตอร์ตั้งฉาก',rune:'รูนแห่งมุมฉาก',intro:'ทางออกถูกผนึกด้วยใยตั้งฉาก ต้องสร้างเวกเตอร์ B ที่ตั้งฉากกับ A และ C ที่ตั้งฉากกับ -A อย่างละหนึ่งตัวอย่าง',learn:{title:'หาเวกเตอร์ตั้งฉากและตรวจด้วย dot product',sample:'กำหนด P = (3, 2) จงหาเวกเตอร์ Q ที่ตั้งฉากกับ P หนึ่งตัวอย่าง',steps:['ถ้าเวกเตอร์เดิมคือ <b>(x, y)</b> เวกเตอร์ตั้งฉากเลือกได้เป็น <b>(y, -x)</b> หรือ <b>(-y, x)</b>','แทน x = 3 และ y = 2 เลือกได้ Q = <b>(2, -3)</b>','ตรวจด้วยสูตร dot product: P · Q = (3)(2) + (2)(-3)','คำนวณได้ 6 - 6 = <b>0</b> ดังนั้น P ⟂ Q และมุมระหว่างกันเท่ากับ 90°'],formula:'P · Q = PₓQₓ + PᵧQᵧ = 0 &nbsp;⇒&nbsp; <em>P ⟂ Q</em>'},hint:'ใช้ตัวอย่างเดียวกับเฉลย: สำหรับ A = (-20, -21) เลือก B = (-21, 20) และสำหรับ -A = (20, 21) เลือก C = (21, -20) คู่นี้จะถูกใช้ต่อในข้อ 5 กด “เติมตัวอย่าง” ได้เลย',question:'จงหา B ที่ตั้งฉากกับ A และ C ที่ตั้งฉากกับ -A มาอย่างละหนึ่งตัวอย่าง โดยเกมใช้ตัวอย่างตามเฉลย B = (-21, 20) และ C = (21, -20) ต่อเนื่องในข้อ 5',inputs:[['bx','Bₓ'],['by','Bᵧ'],['cx','Cₓ'],['cy','Cᵧ']],prefill:{bx:-21,by:20,cx:21,cy:-20},validate:v=>+v.bx===-21&&+v.by===20&&+v.cx===21&&+v.cy===-20,explain:'ผ่านด่าน! ตรวจ B: (-20)(-21) + (-21)(20) = 420 - 420 = 0 และตรวจ C: (20)(21) + (21)(-20) = 420 - 420 = 0 เมื่อ dot product เป็น 0 เวกเตอร์จึงตั้งฉากกัน',vectors:[[ -20,-21,'A','#75859f'],[-21,20,'B','#55e6d9'],[20,21,'-A','#75859f'],[21,-20,'C','#ffd166']]},
  {id:5,name:'จักรพรรดิยูนิต ผู้คุมขนาดหนึ่ง',title:'ศึกพิชิตเวกเตอร์หนึ่งหน่วย',glyph:'V̂',quote:'เวกเตอร์ทุกตัวต้องผ่านการย่อขนาดให้เหลือหนึ่ง ก่อนจะเปิดเผยทิศทางที่แท้จริง!',map:'ปราสาท Unit Vector',rune:'รูนแห่งเวกเตอร์หนึ่งหน่วย',intro:'จักรพรรดิยูนิตผนึกทางออกไว้ด้วยกฎขนาดหนึ่ง เจ้าต้องทำ B และ C จากข้อ 4 ให้เป็นเวกเตอร์หนึ่งหน่วย แล้วใช้ dot product ตัดสินความสัมพันธ์ของทิศทาง หากได้ -1 แปลว่าเวกเตอร์ทั้งสองชี้ตรงข้ามกัน',learn:{title:'Unit vector คือเวกเตอร์ที่ย่อให้ยาว 1',sample:'ให้ P = (3, 4) และ Q = (-3, -4) หา p̂ · q̂',steps:['|P| = |Q| = 5','หารแต่ละองค์ประกอบด้วยขนาด: p̂ = (3/5, 4/5)','q̂ = (-3/5, -4/5)','dot product = (3/5)(-3/5) + (4/5)(-4/5) = -25/25 = <b>-1</b>'],formula:'p̂ · q̂ = cos(θ) · ตรงข้ามกัน θ=180° จึงได้ <em>-1</em>'},hint:'จากข้อ 4 ใช้ B = (-21, 20) และ C = (21, -20) จะเห็นว่า C = -B จึงมีทิศตรงข้ามกัน หลังทำเป็น unit vector ค่า dot product เท่ากับ cos(180°)',question:'จากข้อ 4 กำหนด B = (-21, 20) และ C = (21, -20) จงคำนวณ dot product ระหว่าง unit vector ของ B กับ unit vector ของ C',inputs:[['dot','B̂ · Ĉ']],validate:v=>Number.isFinite(Number(v.dot))&&Math.abs(Number(v.dot)+1)<.001,explain:'ชัยชนะ! เมื่อใช้ B = (-21, 20) และ C = (21, -20) จะได้ |B| = |C| = 29, B̂ = (-21/29, 20/29), Ĉ = (21/29, -20/29) และ B̂ · Ĉ = (-441 - 400)/841 = -1 จึงชี้ตรงข้ามกัน',vectors:[[-21,20,'B̂','#55e6d9'],[21,-20,'Ĉ','#ffd166']]}
];
